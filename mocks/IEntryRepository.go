...
// Check provides a mock function with given fields: e, loc
func (_m *IEntryRepository) Check(e *models.Entry, loc *time.Location) error {
	ret := _m.Called(e, loc)

	var r0 error
	if rf, ok := ret.Get(0).(func(*models.Entry, *time.Location) error); ok {
		r0 = rf(e, loc)
	} else {
		r0 = ret.Error(0)
	}
